...
class Client:
    ...
    def _open_viewer(self) -> None:
        ...
        frame_hand_camera(self.viewer, self.model, self.data, WRIST_BODY, azimuth=-145.0)
                    ...
                    if event_id == "launch_viewer":
                        ...
                        if len(self.metadata) > 0:
                            self.node.send_output(
                                "mj_l_joints_pos", pa.array(self.motor_pos), self.metadata
                            )
